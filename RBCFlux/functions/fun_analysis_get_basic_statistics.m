...
stat_str = fun_initialized_structure_array_with_fieldname_list({'num_data',...
    'min', 'max', 'mean', 'median', 'sum', 'std', 'cv', 'range',...
    'hist_count', 'hist_edge', 'hist_bin_val', 'hist_probability', 'hist_pdf',...
    'hist_bin_size', 'hist_num_edge', 'hist_cumulate_count', ...
...
stat_str.cv = stat_str.std / stat_str.mean;
