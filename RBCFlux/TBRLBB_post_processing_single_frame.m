...
stack_list = {'JD230627M002_100423'};
...
%             vis_data.radius.r_or = vis_data.process_radius_data([vis_data.data.radius.radius_um].');
            ...
            vis_data.radius.r_or = vis_data.process_radius_data(radius_l_data_med); %Detect and replace outliers
            ...
            % Bandpass filter appers to have a broad transition frequency
            % band...? 
                %% long pass filder
