% Adapted from TBRLBB_processing_pipeline_single_frame.m
clc;clear;close all;
DataManager = FileManager;
dataset_name = 'DKLab';
stack_list = {'JD230627M997_101123'};
...
for stack_idx = 1 : num_stack
    ...
    parfor iter_file = 1 : data_info.num_files
        ...
        try
            ...
            %% RBC segmentation
            rbc_seg_cell = VRRBCFlux.compute_rbc_cc(ls_im, vsl_mask, ...
